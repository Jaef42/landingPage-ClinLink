...
export const SideBar = () => {
    ...
    const handleRegisterClick = () => {
        window.open("https://clin-link-system.vercel.app/register");
    };
    const handleLoginClick = () => {
        window.open("https://clin-link-system.vercel.app/");
    }
            ...
            <div /* className='side-bar' */>
                <nav className='nav-side'>
                    <ul>
                        ...
                        <li className='li'>
                            <button onClick={handleRegisterClick} className='button-link'>
                        ...
                        <li className='li'>
                            <button onClick={handleLoginClick} className='button-link'>Iniciar Sesión

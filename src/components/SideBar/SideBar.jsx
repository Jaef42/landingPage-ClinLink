            ...
            <div /* className='side-bar' */>
                <nav className='nav-side'>
                    <ul>
                        ...
                        <li className='li'>
                        <button onClick={handleRegisterClick} className='link' style={{ background: 'none', border: 'none', padding: 0, cursor: 'pointer' }}>
                        ...
                        <li className='li'>
                            <Link to={{ pathname: "https://clin-link-system.vercel.app/" }} target="_blank" className='link'>
